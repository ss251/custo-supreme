...
import { Building, Briefcase, Hospital, GraduationCap, Factory, ShoppingBag, Sparkles } from 'lucide-react';
    ...
    <section id="services" className="py-24 bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mb-8">
          ...
          <button
            className={`px-6 py-2 ${activeTab === 'floor' ? 'bg-primary text-white' : 'bg-gray-200 text-gray-700'} rounded-full`}
