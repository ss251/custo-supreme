        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-600 mb-6">
              With over 10 years of experience in the commercial cleaning industry, Custo Supreme has established itself as a leader in providing top-quality cleaning services to businesses across Chattanooga, TN and Houston, TX.
            </p>
