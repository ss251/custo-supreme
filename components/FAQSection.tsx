...
const faqs = [
  ...
  },
  {
    ...
    answer: "The frequency of cleaning depends on your specific needs. We offer weekly, bi-weekly, and monthly services, as well as one-time deep cleans. We'll work with you to determine the best schedule for your business."
  },
  {
